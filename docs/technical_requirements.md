...
- [2. Описание системы](#2-описание-системы)
  ...
  - [2.5. Функционал пользователя](#24-функционал-пользователя)
    ...
    - [2.5.9 Просмотр аналитики (?)](#259-просмотр-аналитики)
  - [2.6. Функционал руководителя](#25-функционал-руководителя)
  - [2.7. Админ панель для управления данными](#26-админ-панель-для-управления-данными)
  - [2.8. Функционал интеграции с облачным хранилищем](#27-функционал-интеграции-с-облачным-хранилищем)
  - [2.9. Аналитика](#28-аналитика)
  - [](#)
...
### 2.5.9 Просмотр аналитики (?)

## 2.6. Функционал руководителя
